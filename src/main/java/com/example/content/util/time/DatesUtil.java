...
public class DatesUtil {
	 ...
	 * @return
	 */
	public static String format(Date date, String mat){
		SimpleDateFormat simpleDateFormat = new SimpleDateFormat(mat);
		return simpleDateFormat.format(date);
	}

	public static String LocalDateTimeFormat(LocalDateTime localDateTime, String mat){
		DateTimeFormatter format = null;
		if (mat == null){
			format = DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss");
		}else{
			format = DateTimeFormatter.ofPattern(mat);
		}
	 ...
	 */
	public static Date  addDateMinutes(Date oldTime,int add){
	//	int addMit = Integer.valueOf(add);
		Date expireTime = new Date(oldTime.getTime() + add*60*1000);
		return expireTime;
	}
